        ...
        values: {
          tickers: {
            ...
            values: {
              ...
              updated: {
                type: "number",
                description: "Last updated timestamp (nanoseconds since epoch)",
              },
              day: {
                type: "object",
                values: {
          ...
          results: {
            ...
            values: {
              ...
              participant_timestamp: {
                type: "number",
                description: "Participant timestamp (nanoseconds since epoch)",
              },
              sequence_number: {
                type: "number",
  ...
  "stocks/bars-info": [
    {
      ...
      example: {
        ...
        values: {
          ...
          adjusted: {
            type: "boolean",
            description: "Whether the data is adjusted",
          },
          results: {
            type: "Array of object",
            values: {
  ...
  "orders/order-buy": [
    {
      ...
      example: {
        ...
        values: {
          alpacaOrderId: {
            type: "string",
            description: "Alpaca order identifier",
          },
          ...
          order_type: {
            type: "string",
            description: "Type of order (limit/stop/etc)",
          },
          ...
          fractionable: {
            type: "boolean",
            description: "Whether the order is fractionable",
          },
          ...
          orderData: {
            ...
            values: {
              ...
              replaced_by: {
                type: ["string", "null"],
                description: "Replaced by order ID",
              },
              replaces: {
                type: ["string", "null"],
                description: "Replaces order ID",
              },
              ...
              extended_hours: {
                type: "boolean",
                description: "Extended hours flag",
              },
              legs: { type: ["array", "null"], description: "Order legs" },
              trail_percent: {
                type: ["number", "null"],
                description: "Trail percentage",
              },
              trail_price: {
                type: ["number", "null"],
          ...
          scheduledOrdersIds: {
            type: "array",
            description: "Scheduled order IDs",
          },
          open_order_id: {
            type: ["string", "null"],
  ...
  "orders/pending-order-list": [
    {
      ...
      example: {
        ...
        values: {
          ...
          imgUrlDark: {
            type: "string",
            description: "Dark mode company logo URL",
          },
  ...
  "orders/order-details": [
    {
      ...
      example: {
        ...
        values: {
          ...
          asset_class: {
            type: "string",
            description: "Class of the asset (e.g., us_equity)",
          },
          asset_marginable: {
            type: "boolean",
            description: "Whether the asset can be margined",
          },
          ...
          change_today: {
            type: "string",
            description: "Price change percentage today",
          },
          qty_available: {
            type: "string",
          ...
          boughtPrice: {
            type: "number",
            description: "Price at which the position was bought",
          },
          ...
          isBookmark: {
            type: "boolean",
            description: "Whether the stock is bookmarked",
          },
          fractionable: {
            type: "boolean",
            description: "Whether the stock supports fractional shares",
          },
        },
      },
    },
  ...
  "orders/delete-pending-order": [
    {
      ...
      example: {
        ...
        values: {
          ...
          status: {
            type: "string",
            description: "Order status (e.g., canceled)",
          },
          client_order_id: {
            type: "string",
            description: "Client's order identifier",
        ...
        values: {
          success: {
            ...
            values: {
              ...
              replaced_at: {
                type: ["string", "null"],
                description: "Order replacement timestamp",
              },
              replaced_by: {
                type: ["string", "null"],
                description: "ID of order that replaced this one",
              },
              replaces: {
                type: ["string", "null"],
                description: "ID of order that was replaced",
              },
              ...
              subtag: { type: ["string", "null"], description: "Subtag" },
              source: { type: ["string", "null"], description: "Order source" },
              expires_at: {
                type: "string",
                description: "Expiration timestamp",
              },
              shortName: { type: "string", description: "Short company name" },
              name: { type: "string", description: "Full company name" },
              imgUrl: { type: "string", description: "Company image URL" },
              imgUrlDark: {
                type: "string",
                description: "Dark mode company image URL",
              },
              stockName: { type: "string", description: "Stock name" },
            },
          },
        ...
        values: {
          tradeActivity: {
            ...
            values: {
              id: {
                type: "string",
                description: "Unique identifier for the trade activity",
              },
              account_id: { type: "string", description: "Account identifier" },
              activity_type: {
                type: "string",
                description: "Type of activity (e.g., FILL)",
              },
              transaction_time: {
                type: "string",
        ...
        values: {
          ...
          nonTradeActivity: {
            ...
            values: {
              ...
              activity_type: {
                type: "string",
                description: "Type of activity (e.g., FEE)",
              },
              activity_sub_type: {
                type: "string",
                description: "Subtype of activity (e.g., CAT)",
              },
              date: { type: "string", description: "Activity date" },
              net_amount: {
                type: "string",
                description: "Net amount of the activity",
              },
              description: {
                type: "string",
